...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $price = $_POST['price'];
    $stock = $_POST['stock'];
    $current_image = $product['image_path']; // Gambar yang ada sekarang

    $new_image_path = $current_image; // Default tetap gambar lama
